...
<link
	href="https://fonts.googleapis.com/css2?family=Lobster&family=Lobster+Two&family=Oswald&family=Poppins&family=Raleway&display=swap"
	rel="stylesheet">
<link
...
<body>
	...
	<form action="login.do" method="post" enctype="multipart/form-data"
		...
		<input id="email" type="hidden" name="email"> <br> <input
