...
.btn {
	...
	padding: 0px;
	/* border-color: pink; */
	text-shadow: 1px 0px #F473B9, 0px 1px #F473B9, 1px 0px #F473B9, 0px -1px
		#F473B9;;
	color: white;
	background-color: white;
	font-size: 1.33em;
...
<body>
  ...
  *개인 정보 조회와 수정하세요">
				...
				<div class="col text-white">
					...
					<input type="button"
						onclick="location.href='/travel/reservation/hostlist.do';"
						class="btn btn-secondary gain "
						value="
  ...
  *예약 받은 숙소를 조회하세요">
				...
				<div class="col text-white">
					<span class="material-icons-outlined add">add_home_work</span> <input
						type="button"
						onclick="location.href='/travel/accommodation/insertAcco.jsp';"
						class="btn btn-secondary gain "
						value="
  ...
  *회원을 탈퇴 할 수 있어요">
			...
			<div class="row">
				...
				<div class="col text-white">
					...
					<input type="button"
						onclick="location.href='/travel/user/selectAccoHost.do';"
						class="btn btn-secondary gain btn1"
						value="
