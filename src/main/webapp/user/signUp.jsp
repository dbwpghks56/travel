		...
		<form action="signup.do" method="post" enctype="multipart/form-data">
			...
			<div class="input-group mb-3">
				<span class="input-group-text">아이디</span> <input type="text"
					...
					value="${email}" required="required"> <input type="button"
					id="idDuplicateCheckBtn" value="중복확인">
			</div>
			...
			<div class="input-group mb-3">
				<span class="input-group-text">닉네임</span> <input type="text"
					...
					id="nickname" value="${nick }" required="required"> <input
					type="button" id="nickDuplicateCheckBtn" value="중복확인">
			</div>
			...
			<div class="input-group mb-3">
				<span class="input-group-text">프로필</span> <input type="file"
					...
					accept="image/*" onchange="setThumbnail(event);"> <img
					alt="" src="" id="thumbnail">
			</div>
